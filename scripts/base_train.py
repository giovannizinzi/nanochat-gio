...
parser.add_argument("--n-kv-head", type=int, default=-1, help="number of KV heads for GQA (-1 = full MHA = n_head)")
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        n_layer=depth, n_head=num_heads, n_kv_head=(args.n_kv_head if args.n_kv_head > 0 else num_heads), n_embd=model_dim,
