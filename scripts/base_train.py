...
parser.add_argument("--embed-norm", action=argparse.BooleanOptionalAction, default=True, help="Scaled Embed / Spike-No-More (arxiv 2312.16903): normalize wte output before the trunk. Default True (on). Use --no-embed-norm to disable.")
